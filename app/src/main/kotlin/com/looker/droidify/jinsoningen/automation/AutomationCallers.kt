/*
 * 白い熊 人造人間 (shiroikuma-jinsoningen) fork: who may drive the 保存復元 data door.
 * Copied verbatim in substance from shiroikuma-jiyusagyoban, which defines the contract — it is
 * deliberately app-independent, and the pins are the family's.
