...
**📥 Latest release: [`0.7.8+001`](https://github.com/ShiroiKuma0/shiroikuma-jinsoningen/releases/latest)** — [all releases & APK downloads »](https://github.com/ShiroiKuma0/shiroikuma-jinsoningen/releases)
...
`versionName` is upstream's version plus our build counter — `0.7.8+001` — and `versionCode` is
upstream's code times 10 000 plus that counter (`780 × 10000 + 1 = 7800001`). The counter bumps on
...
- **`main`** — mirrors the upstream **release tag** we are based on (currently `v0.7.8`).
