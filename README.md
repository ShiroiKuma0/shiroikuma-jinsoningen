...
**📥 Latest release: [`0.7.4+008`](https://github.com/ShiroiKuma0/shiroikuma-jinsoningen/releases/latest)** — [all releases & APK downloads »](https://github.com/ShiroiKuma0/shiroikuma-jinsoningen/releases)
...
`versionName` is upstream's version plus our build counter — `0.7.4+008` — and `versionCode` is
upstream's code times 10 000 plus that counter (`740 × 10000 + 8 = 7400008`). The counter bumps on
